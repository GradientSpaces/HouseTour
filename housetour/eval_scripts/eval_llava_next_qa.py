...
def generate_qa_answer(video_idx, question):
    max_frames_num = 96
...
if __name__ == "__main__":
    # Q&A Eval
    with open("/scratch/users/atacelen/Reconstructions3D/annotations_q_and_a.json", "r") as f:
        qa = json.load(f)
    ...
    qa = [d for d in qa if d["scene_id"] in val_idxs]
    ...
    output_file = "eval_llava_next.jsonl"
    ...
    for d in tqdm(qa):
        ...
        predicted_answer = generate_qa_answer(d["scene_id"], question)
