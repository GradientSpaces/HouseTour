...
from cosmos_tokenizer.processors import Blip2ImageEvalProcessor
...
class Chat:
    ...
    def answer(self, conv, img_list, max_new_tokens=300, num_beams=1, min_length=1, top_p=0.9, top_k = 50,
        ...
        transition_scores = self.model.llama_model.compute_transition_scores(
        ...
        return output_text, output_token.cpu().numpy(), transition_scores, attn
    ...
    def get_context_emb(self, conv, img_list):
        ...
        print(f"Image List Shape: {img_list[0].shape}")
        ...
        # Turn back to tokens from ids
        # print("Prompt tokens:")
        # print([self.model.llama_tokenizer.convert_ids_to_tokens(seg_t[0]) for seg_t in seg_tokens])
        if self.model.lora:
